...
public class ReporteController {
    ...
    public ResponseEntity<Resource> reporteVentasTotales(
        ...
        // Los nombres de parámetros deben coincidir con los que espera JasperReports
        parametros.put("fechaInicial", fechaInicio);  // Cambiar a fechaInicial
        parametros.put("fechaFinal", fechaFin);       // Cambiar a fechaFinal
